    ...
    <div className="max-w-3xl m-auto my-4 sm:my-16 px-8">
      ...
      <ProjectSection>
        ...
        <ProjectSectionDescription isOdd>
          ...
          <p className="text-gray-500">
            ...
            progress of your team members based on the issues assigned to them.
          </p>
        </ProjectSectionDescription>
      </ProjectSection>
      ...
      <ProjectSection>
        ...
        <ProjectSectionDescription isOdd>
          ...
          <p className="text-gray-500">
            Manage the roles of each one of your team members. With 3 different
            roles, leader, submitter, and developer. Leader role can only be
            assigned from the Project Settings page.
          </p>
        </ProjectSectionDescription>
      </ProjectSection>
